...
class Window(tk.Tk):
    ...
    def MoveToStatisticWindow(self):
...
class MainMenuWindow(Window):
    def __init__(self):
        ...
        self.start_button = tk.Button(text = "Start new game!", font = ("Comic Sans", 14),
                                             command = lambda: self.MoveToSelectionWindow())
        self.move_to_load_button = tk.Button(text = "Check game history",
                                             font = ("Comic Sans", 14),
                                             command = lambda: self.MoveToStatisticWindow())
    def show(self):
    ...
    def typing(self, event):
        ...
        if self.check_symbols(new_symbol, first_symbol):
            ...
            if (len(self.text) == 0 or (len(self.text) == 1
                ...
                result = "Game " + str(line_number) + ", text: " + str(self.text_name) + ", words: " + str(self.words_number) + ", time: " + str(self.game_time) + "\n" 
                print(result)
...
class FinishedGameWindow(Window):
    def __init__(self, previous):
        ...
        self.menu_button = tk.Button(text = "Go to main menu", font = ("Comic Sans", 14),
                                         command = lambda: self.MoveToMainWindow())
